...
import { detectFVG, detectStructure, detectLiquidity, premiumDiscount } from './smc.engine.js'
...
export const SMC_TOOLS = [
    ...
    { name: 'get_structure', description: 'Market structure from OHLCV: trend (up/down/range), the last BOS (continuation) or CHoCH (reversal) with its exact broken level, the last swing high/low, and the premium/discount split of the dealing range. SMC mode\'s core structural read.', input_schema: _schema },
