...
- **LLM:** Anthropic Claude for every desk (Sonnet 5 default since 2026-09-20) — the model is the
  ...
  through `providers/openaiCompat.provider.js` — GPT-5.6 Luna, Qwen3.7-Plus, Mistral Medium 3.5, Qwen3.7 Flash,
  DeepSeek V4.1 Flash and Gemini 3.8 Flash for the desks, and the Talos candidates (`docs/design/talos-replay-harness.md`). OpenAI's own SDK is otherwise Whisper
